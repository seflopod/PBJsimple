...
namespace scene {
    ...
    /// \date   2013-08-08
    ///
    /// \details    This class contains muliple unordered maps call EntityMap
    ///             that will map an id number to a given Entity.  The maps are
    ///             separated by EntityType.  When new types are added, the new
    ///             maps will have to be added and handled.  Currently the UIRoot
    ///             for the Scene is left as a global variable, which could
    ///             probably change but until we have the user interface stuff
    ///             down I'm leaving it as is.
    ////////////////////////////////////////////////////////////////////////////
    class Scene
    {
    public:
